...
## THS 1
Projemizde mermelerin kalite sınıflandırması temel alınarak ilerlenmiş olup bunun yanında mermrler tür tespiti,renk analizi ve veri seti üretici gibi kısımlarıda bulunmaktadır.Aşağıda kalite sınıflandırmasına ilişkin biligiler yer edinmiştir.
